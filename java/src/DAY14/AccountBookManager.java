...
public class AccountBookManager implements ConsoleProgram {
	...
	public void excute(int menu) {
		...
		case 2:
		    if(insertAccountBook()) {
		    	...
		    	System.out.println("내역 추가헤 실패했습니다.");
		    }
		    System.out.println("====================");
		    break;
		case 3:
	...
	public void readAccountBook() {
		System.out.println("전체[1, 날짜[2] 선텍 : ");
	...
	public boolean modifyAccountBook() {
		...
		System.out.println("=====================");
		System.out.println("선택한 항목 내역은 위 내역입니다, 수정하시겠습니까>[예:true/아니오:false]");
	    ...
	    System.out.println("결제방식을 수정하겠습니까?(예:true/아니오:false) : ");			
	    ok = scan.nextBoolean();
	    ...
	    System.out.println("항목을 수정하겠습니까?(예:true/아니오:false) : ");			
	    ok = scan.nextBoolean();
	    ...
	    System.out.println("금액을 수정하겠습니까?(예:true/아니오:false) : ");			
	    ok = scan.nextBoolean();
	    int price2 = -1;
	    if(ok) {
	    	System.out.print("금액 : ");
